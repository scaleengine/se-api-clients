...
*******************************************************************************
**                           stream_add.php                                  **
** Example of how to create a stream using the ScaleEngine API.              **
** Other objects can be created using the same method, by calling the        **
...
$timeout = 180;
$endpoint = 'streams';
$object = ''; // use empty object when creating
$method = 'PUT'; // Use put method to create
...
$data = array(
    ...
    "segment_value"	=> "* */2 * * *", // split recordings every other hour
);
