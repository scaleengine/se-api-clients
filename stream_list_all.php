...
*******************************************************************************
**                           stream_list_all.php                             **
** Example of how to list all streams using the ScaleEngine API.             **
** Other listings of all objects of a type can be done with the same method  **
...
$timeout = 180;
$endpoint = 'streams';
$object = ''; // use empty object when list all
