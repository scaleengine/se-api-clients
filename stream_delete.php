...
*******************************************************************************
**                           stream_delete.php                               **
** Example of how to delete a stream using the ScaleEngine API.              **
** Other objects can be deleted using the same method, by calling the        **
...
$timeout = 180;
$endpoint = 'streams';
$object = $stream_name; // use stream_name to set the object to delete
$method = 'DELETE'; // Use delete method to delete
